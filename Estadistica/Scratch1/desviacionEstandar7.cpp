...
int main(int argc, char **argv) {
	...
	/*11.9640;0.0000;0.0000;0.9841;
12.3640;-0.0159;0.0159;0.9524;
12.7640;0.0000;0.0000;1.0000;*/
	
	// Aceleración en x
	double x1 = 0.0000, x2 = -0.0159, x3 = 0.0000;
	...
	var = (pow(x1-med, 2) + pow(x2-med, 2) + pow(x3-med, 2))/3;
