...
int main(int argc, char **argv) {
	...
	/*4.1980;0.0000;0.0159;0.9841;
4.5980;0.0000;0.0000;0.9841;
4.9980;-0.0159;-0.0317;0.9683;
5.3980;-0.0317;-0.0159;0.9841;
5.7980;0.0159;-0.0159;0.9524;*/
	
	// Aceleración en x
	double x1 = 0.0000, x2 = 0.0000, x3 = -0.0159, x4 = -0.0317, x5 = 0.0159;
