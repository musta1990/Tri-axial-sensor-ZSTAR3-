...
int main(int argc, char **argv) {
	...
	/*7.9640;-0.0317;0.0000;0.9683;
8.3640;-0.0159;-0.0159;0.9683;
8.7640;0.0159;-0.0317;0.9841;
9.1640;0.0000;-0.0159;0.9683;
9.5640;0.0000;0.0000;1.0000;*/
	
	// Aceleración en x
	double x1 = -0.0317, x2 = -0.0159, x3 = 0.0159, x4 = 0.0000, x5 = 0.0000;
