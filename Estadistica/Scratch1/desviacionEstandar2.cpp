...
int main(int argc, char **argv) {
	...
	/*2.1980;0.0159;-0.0159;0.9683;
2.5980;0.0000;0.0000;0.9841;
2.9980;0.0159;-0.0159;0.9841;
3.3980;0.0000;-0.0159;0.9841;
3.7980;0.0159;-0.0159;0.9683;*/
	
	// Aceleración en x
	double x1 = 0.0159, x2 = 0.0000, x3 = 0.0159, x4 = 0.0000, x5 = 0.0159;
