...
int main(int argc, char **argv) {
	...
	/*6.1980;-0.0159;-0.0159;0.9683;
6.5980;0.0159;0.0000;0.9683;
6.9980;0.0317;0.0000;0.9841;
7.1640;-0.0317;-0.0159;0.9683;
7.5640;0.0000;-0.0159;0.9841;*/
	
	// Aceleración en x
	double x1 = -0.0159, x2 = 0.0159, x3 = 0.0317, x4 = -0.0317, x5 = 0.0000;
