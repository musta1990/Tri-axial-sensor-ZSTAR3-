...
int main(int argc, char **argv) {
	...
	/*9.9640;0.0000;0.0000;0.9524;
10.3640;-0.0159;-0.0159;0.9841;
10.7640;0.0000;-0.0159;0.9841;
11.1640;-0.0159;0.0000;0.9683;
11.5640;0.0159;-0.0159;0.9841;*/
	
	// Aceleración en x
	double x1 = 0.0000, x2 = -0.0159, x3 = 0.0000, x4 = -0.0159, x5 = 0.0159;
